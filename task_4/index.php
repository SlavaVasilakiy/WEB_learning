...
$work_experience = [
    ...
    [
        ...
        'date_end' => 'March 2022',
        'text' => 'Nulla tempora soluta ea et odio, unde doloremque repellendus
        iure, iste.',
    ],
    [
        'name' => 'Уличный кот',
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i
            ...
            <div class="w3-container">
                ...
                <?php endif;?>
                <?php //чуть не кончился, пока разобрался как правильно if else вставить сюда <<рукалицо>> ?>
            <p><?= $work_experience[$i]['text']; ?></p>
            <hr>
          </div>
            <?php endfor;?>
